...
const defaultSvg = `<svg width="200" height="200" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="50" y="-30" width="60" height="40" />
    ...
    <div className="w-full h-screen">
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 left-4 z-10 bg-black/50 hover:bg-black/70 text-white p-2 rounded-lg backdrop-blur-sm border border-gray-600 transition-colors"
