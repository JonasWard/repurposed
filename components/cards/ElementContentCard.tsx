...
const getMailTo = (element: ListingData) => {
  return `mailto:${EMAIL}?subject=Listing ${element.name}&body=I am interested in the listing ${element.name} (${element.type}). I would like to know more about it and how to purchase it.`;
};
